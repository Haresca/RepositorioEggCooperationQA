...
public class TiendaServicio {
    ...
    public void venderProductos(List<Tienda> tiendas) {
        Tienda tienda = seleccionarTienda(tiendas);
        ProductoServicio productoServicio = new ProductoServicio();
        Producto compra = productoServicio.seleccionarProducto(tienda.getProductosStock().keySet().stream().collect(Collectors.toList()));
    ...
    public void eliminarProductos(List<Tienda> tiendas) {
        ...
        ProductoServicio productoServicio = new ProductoServicio();
        Producto eliminar = productoServicio.seleccionarProducto(tienda.getProductosStock().keySet().stream().collect(Collectors.toList()));

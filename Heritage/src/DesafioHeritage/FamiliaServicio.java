...
public class FamiliaServicio {
    ...
    private List<Integer> ingresoFactoresRiesgo(ConFactorRiesgo conFactorRiesgo) {
        ...
        return factores.stream().collect(Collectors.toList());
    }
    ...
    private Familia seleccionaFamilia(List<Familia> familias) {
        do {
            ...
            String ide = scan.nextLine();
            List<Familia> familiasCondicion = familias.stream().filter(familia -> familia.getIde().equalsIgnoreCase(ide)).collect(Collectors.toList());

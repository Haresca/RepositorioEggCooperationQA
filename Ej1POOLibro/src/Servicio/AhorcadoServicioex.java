 ...
 * @author carlo
 */
public class AhorcadoServicioex {

    Scanner leer = new Scanner(System.in).useDelimiter("\n");
    Ahorcadoex ahorcado = new Ahorcadoex();

    public Ahorcadoex crearJuego() {
    ...
    public void longitud(Ahorcadoex ahorcado) {
        System.out.println("La longitud de la palabra a encontrar es: " + ahorcado.getBuscar().length);
    }

    public boolean buscar(Ahorcadoex ahorcado, String[] vectorCopia) {
    ...
    public void intentos(Ahorcadoex ahorcado) {
